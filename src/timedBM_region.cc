...
int main(int argc, char *argv[])
{
  ...
  for (int i = 0;i < loopTimes; i++ ) {
    ...
    case 6:
      ...
      break;
    case 7:
      timedBoyerMoore (w,TA7,ans,hashCalcCount);
      break;
    case 8:
      timedBoyerMoore (w,TA8,ans,hashCalcCount);
      break;
    case 9:
      timedBoyerMoore (w,TA9,ans,hashCalcCount);
      break;
    case 10:
      timedBoyerMoore (w,Phi8,ans,hashCalcCount);
      break;
    case 11:
      timedBoyerMoore (w,Phi5,ans,hashCalcCount);
      break;
    case 12:
      timedBoyerMoore (w,Phi4,ans,hashCalcCount);
      break;
    case 13:
      timedBoyerMoore (w,hscc2014,ans,hashCalcCount);
      break;
    case 14:
      timedBoyerMoore (w,hscc2014_2,ans,hashCalcCount);
      break;
    }
